  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center p-6 text-center font-sans">
      <div className="w-20 h-20 bg-white/5 border border-white/10 rounded-full flex items-center justify-center mb-6 shadow-2xl">
        <Lock size={32} className="text-[#00D8FF]" />
      </div>
      ...
      <button onClick={() => window.location.href = 'https://hilex.app/pricing'} className="bg-[#00D8FF] text-black font-black uppercase tracking-widest px-8 py-4 rounded-xl shadow-[0_0_20px_rgba(0,216,255,0.4)] active:scale-95 transition-all w-full max-w-xs">
          ...
          <div className="p-6 h-full flex flex-col">
            ...
            <div className="space-y-1">
              {drawerItems.map(item => (
                ...
                >
                  <item.icon size={20} className="text-slate-500 group-active:text-[#00D8FF]" />
                  <span className="font-bold text-sm tracking-tight group-active:text-[#00D8FF]">{item.label}</span>
                </div>
              ))}
            </div>
